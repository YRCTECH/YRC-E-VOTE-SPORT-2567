...
<body class="d-flex align-items-center justify-content-center w-100" style="min-height: 100vh;">
    ...
    <div class="col-10 col-md-9 col-xl-6 d-block d-md-flex shadow-lg rounded-4 bg-white">
        ...
        <div class="col-12 col-md-6">
            <form action="../process/admin/login_db.php" method="post" class="p-5 pb-1 pt-4 d-flex flex-column" style="min-height: 100%;">
                <!-- Logo -->
                <div class="mb-4">
                ...
                <!-- Title -->
                <div class="mb-5">
                    <h3 class="text-res text-center fs-bold">ระบบเลือกตั้ง<br>ประธานคณะสี <b class="text-danger">Admin</b></h3>
                    <p class="text-secondary text-center m-0 fs-bold" style="font-size: small;">ปี พ.ศ. 2567</p>
                </div>

                <!-- ID -->
                <div class="mb-4">
                    <input type="text" name="username" id="username" class="inp-login" placeholder="ชื่อผู้ใช้งาน" autocomplete="off">
                </div>
